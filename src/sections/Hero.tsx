...
export default function Hero() {
  return (
    <header className="w-full">
      <div className="flex flex-col justify-center items-center py-6 md:p-10 w-full gap-y-6 md:gap-y-10 hero">
        <div className='flex flex-col items-center gap-y-4 md:gap-y-6'>
          <div className="flex items-center gap-x-2 p-1 rounded-full bg-white/4 border border-white/8">
            ...
            <span className="body-text-small-medium text-white mr-2">
              v1.2 Beta is available
            </span>
          </div>
          <h1 className='text-h5 md:text-h3 lg:text-h2 max-w-[596px] inline-block text-center justify-center'>Simplify and optimize your <span className='handwrite'>user experience.</span></h1>
        </div>
        <div className='flex flex-col items-center gap-y-4 md:gap-y-6'>
